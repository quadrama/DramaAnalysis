...
dsl <- dictionaryStatistics(rksp.0$mtext, 
                            fieldnames = c("Liebe","Krieg","Familie","Religion"),
                            baseurl = "/Users/reiterns/Documents/QuaDramA/metadata/fields/",
                            normalizeByFigure=TRUE,
                            asList=TRUE,
                            segment="Scene")

dsl <- individualize(dsl)
...
legend(x="topright",legend=colnames(dsl$marinelli$mat),lty=1:5)
```
...
legend(x="topright",legend=colnames(mat),lty=1:5)
```
