...
print(class(params$ids))
print(params$ids[[2]])
text <- loadSegmentedText(params$ids)
meta <- loadMeta(params$ids)
characters <- loadCharacters(params$ids)
...
```{r}
#tl <- limitFigures(text, threshold = 15)
ustat <- utteranceStatistics(text, numberOfFigures = 20)
