...
legend(x="center",lty=2:3,legend=c("Trilcke et al. (2017)", "Hamming (Normalized)", "Scenic Difference"),bty="n",horiz=TRUE)

plot(ham, type="l", lty=2, xlab="Scene boundary",ylab="",ylim=c(0,1),frame=TRUE)
par(new=TRUE)
