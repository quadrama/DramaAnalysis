...
b <- characterStatistics(drama, normalize = FALSE) %>%
  ...
  barplot(#names.arg=dramaNames(drama, formatString = "%T"),
          column="tokens",
          main = "Absolute amount of words spoken by each figure (Tokens).")
...
b <- characterStatistics(drama, normalize = FALSE) %>%
  ...
  barplot(#names.arg=dramaNames(drama, formatString = "%T"),
          column="utterances",
          main= "Absolute amount of utterances of each figure.")
```
...
b <- characterStatistics(drama, normalize = FALSE) %>%
  ...
  barplot(#names.arg=dramaNames(drama, formatString = "%T"),
          ...
          main="Mean of the length of the utterances of each figure.")
```
...
b <- characterStatistics(drama, normalize = FALSE) %>%
  ...
  barplot(#names.arg=dramaNames(drama, formatString = "%T"),
          column="types",
          main="Absolute amount of different Words spoken by each figure (Types).")
```
