...
f <- format(hc, rksp.0, sort=1)
test_that("format(sort=1) produces correct output", {
...
f <- format(hc, rksp.0, sort=c(13, 1, 12, 2, 11, 3, 10, 4, 9, 5, 8, 6, 7))
test_that("format(sort=c(13, 1, 12, 2, 11, 3, 10, 4, 9, 5, 8, 6, 7)) produces correct output", {
