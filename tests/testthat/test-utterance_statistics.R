...
ustat <- utterance_statistics(rksp.0, num.figures = 10, normalize.by.drama.length=FALSE)
...
ustat <- utterance_statistics(rksp.0, num.figures = 10, normalize.by.drama.length=TRUE)
